...
that into the controller. Refer to `xref:ag_inv_import[]` in the Automation
...
inventory imports. Refer to the `xref:ug_execution_environments[]` section for
...
detail, see `xref:ug_notifications_on_off[]`.
. if notifications have not been set up, refer to `xref:ug_notifications[]` for
more information.
_________________________________________________________________________________________________________________________________________________________________________________
...
project. See `xref:ag_inv_import[]` in the Automation Controller Administration
Guide for detail.
...
to `xref:ag_inv_import` in the[]` in the Automation Controller Administration
Guide.
